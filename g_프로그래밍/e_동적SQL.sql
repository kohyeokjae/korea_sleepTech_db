...
execute myQuery; -- Error Code: 1243. Unknown prepared statement handler (myQuery) given to EXECUTE

## 동적 SQL문 활용 ##
# : 보안이 필요한 출립문에서 출입한 내열을 자동으로 기록
...
# : 프레이스 홀더, 실제 사용 시 using 키워드를 사용하여 해당 값을 전달
